...
# -lcrypto + -llzma added for the RAR online code: rar_server/rar_client use openssl (TLS, HMAC, SHA) and
# rar_compress.h includes <lzma.h>. Stock upstream linked only -lssl, which predates these additions.
LDFLAGS += -L/usr/local/lib -L/usr/lib/x86_64-linux-gnu -lopenal -lssl -lcrypto -llzma
endif
