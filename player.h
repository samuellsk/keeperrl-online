...
class Player : public Controller, public CreatureView, public EventListener<Player> {
  ...
  PMonsterAI rarAutoAI;   // RAR live PvP: this creature's ordinary minion AI, used while auto fight is on
  struct CommandInfo {
  ...
  private:
  int rarLastRenderMs = 0; // RAR live PvP: throttle the per-turn render so it doesn't slow the simulation
