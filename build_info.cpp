...
static TString getNameHelper(const BuildInfoTypes::BuildType& type, const ContentFactory* factory) {
  return type.visit<TString>(
      ...
      [&](const BuildInfoTypes::PlaceMinionNew& e) { return TStringId("BUILD_MENU_PLACE_MINION"); },
      ...
      [&](const BuildInfoTypes::PlaceItemNew& e) { return TStringId("BUILD_MENU_PLACE_ITEM"); },
      [&](const BuildInfoTypes::RevealLevel& e) { return TString("Reveal level"_s); },
      [&](const BuildInfoTypes::ZLevelDown& e) { return TString("Z-level down"_s); },
      [&](const BuildInfoTypes::ZLevelUp& e) { return TString("Z-level up"_s); },
      [&](const BuildInfoTypes::PlaceFurnitureNew& e) { return TString("Place furniture"_s); },
